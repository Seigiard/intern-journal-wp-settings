...
<article id="post-<?php the_ID(); ?>" <?php post_class('block-article column'); ?>>
	<header class="article--header">
		...
		<div class="lead full"><p><? typograph(get_field('lead_text')); ?></p></div>
...
<footer class="article--footer column">
	...
	<div class="article--outro">
		<?php typograph(get_field('outro_text')); ?>
		<p>
